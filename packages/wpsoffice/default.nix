{
  ...
  url =
    ...
    then "https://wps-linux-personal.wpscdn.cn/wps/download/ep/Linux2023/${lib.last (lib.splitVersion pkgVersion)}/wps-office_${pkgVersion}_amd64.deb"
  ...
  hash =
    if useChineseVersion
    then "sha256-i2EVCmDLE2gx7l2aAo+fW8onP/z+xlPIbQYwKhQ46+o="
    ...
    src =
      ...
      then
        (
          ...
          .${stdenv.system}
          or (throw "wpsoffice-365-${version}: ${stdenv.system} is unsupported.")
        )
      ...
      then
        ...
        ''
          ...
          > $out
        ''
      else (throw "${pname}-${version}: ${stdenv.system} is unsupported.");
