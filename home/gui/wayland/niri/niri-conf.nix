  ...
  settings = {
    ...
    layout = {
      ...
      preset-column-widths = {
        proportion = [(mkargs [0.33333]) 0.5 0.66667];
      };
    ...
    binds = {
      ...
      "Mod+Shift+Return" = {spawn = ["kitty" "-e" "fish" "-ilc" "zj"];};
      ...
      "XF86MonBrightnessUp" = {spawn = ["brightnessctl" "s" "3%+"];};
      "XF86MonBrightnessDown" = {spawn = ["brightnessctl" "s" "3%-"];};
      ...
      "Mod+Shift+Ctrl+O" = {move-workspace-to-monitor-right = {};};
      "Mod+Shift+Ctrl+Y" = {move-workspace-to-monitor-left = {};};
