...
EXEC_FILTER="$HOME/.config/waybar/rofi-menus/run-app-filter"
...
rofi -no-config -no-lazy-grab -dpi 144 -show drun -modi drun -theme ~/.config/waybar/rofi-menus/rofi/launcher.rasi -run-command "fish -c '$EXEC_FILTER {cmd}'"
